...
public interface PontuacaoTimeDAO extends Dao<PontuacaoTime, Integer> {
	...
	/**
	 * Busca a pontuação de determinado campeonato, contanto que possua alguma
	 * fase que tenha pontuação.
	 * <p/>
	 * Muito útil em campeonatos que tenham apenas uma Tabela/Grupo.
	 * <p/>
	 * Em caso de campeonatos com fases de grupo, utilizar outro método de
	 * busca.
	 * 
	 * @param campeonato
	 * @return
