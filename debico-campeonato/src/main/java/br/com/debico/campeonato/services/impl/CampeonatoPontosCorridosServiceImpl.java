...
class CampeonatoPontosCorridosServiceImpl extends CampeonatoServiceImpl
    ...
    @Cacheable(value = CacheKeys.PARTIDAS_RODADA, key = "{#campeonatoPontosCorridos?.id, T(org.joda.time.DateMidnight).now()}")
    ...
    @Override
    public List<CampeonatoPontosCorridos> selecionarCampeonatosPontosCorridosAtivos() {
        return campeonatoDAO.selecionarCampeonatosPCAtivosNaoFinalizados();
    }
     ...
     * @deprecated mover para as factories
     */
