 ...
 * Italiano, Inglês, Francês, Brasileiro (série A e B) e etc. Na prática, é
 * preciso validar.
 * 
 * @author r_fernandes
 * @since 0.1
...
public interface CampeonatoPontosCorridosService extends CampeonatoService {
    ...
    /**
     * Define a fase única para um campeonato de pontos corridos já criado e com
     * os times definidos. Realizações:
     * 
     * <ol>
     * <li>Define uma Fase Única.</li>
     * <li>Associa uma Tabela com os {@value #QUANTIDADE_TIMES_PADRAO} times do
     * campeonato na fase única</li>
     ...
     * </ol>
     * 
     * O administrador deve complementar os dados da partida (data e local) e a
     * rodada correta de acordo com as regras da entidade de futebol local.
     * 
     * @param campeonatoPontosCorridos
     *            campeonato já definido.
     ...
     * <p />
     * No caso de Campeonato de pontos corridos, não é necessário recuperar o
     * Ranking/Tabela/Grupo já que é apenas uma única tabela com o ranking.
     * <p />
     * Os dados já vem ordenados de acordo com as regras gerais de pontuação do
     * campeonato.
     * 
     * @param campeonatoPontosCorridos
     ...
     * @return
     */
    List<PontuacaoTime> selecionarTabela(
            CampeonatoPontosCorridos campeonatoPontosCorridos);

    /**
     * Efetua a listagem de todas as partidas da rodada especificada pelo
     * identificador.
     * 
     */
    ...
    /**
     * Realiza a listagem de todas as partidas de determinada rodada com o
     * ordinal e campeonato especificado.
     * 
     * @param ordinalRodada
     *            sequencial da {@link Rodada}. Ex: 1, 2, 3, 4...n
     * @param campeonato
     * @return
     * @see Rodada#getOrdem()
     */
    List<PartidaRodada> selecionarPartidasRodada(int ordinalRodada,
            String campeonatoPermalink);

    /**
     * Seleciona a rodada atual.
     * 
     * @param campeonatoPontosCorridos
     *            o campeonato desejado.
     * @return
     */
    Rodada selecionarRodadaAtual(
            CampeonatoPontosCorridos campeonatoPontosCorridos);
     ...
     * @since 1.1.0
     */
    Rodada selecionarUltimaRodada(
            CampeonatoPontosCorridos campeonatoPontosCorridos);

    /**
     * Seleciona os campeonatos ativos do tipo Pontos Corridos.
     * 
     * @return
     */
    List<CampeonatoPontosCorridos> selecionarCampeonatosPontosCorridosAtivos();
