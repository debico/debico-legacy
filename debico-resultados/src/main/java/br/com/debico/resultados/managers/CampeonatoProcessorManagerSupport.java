...
abstract class CampeonatoProcessorManagerSupport<T extends Campeonato> extends ProcessorSupport
		implements CampeonatoProcessorManager<T> {
	...
	/**
	 * Retorna o tipo de Campeonato que este {@link Processor} é capaz de
	 * processar.
	 * 
	 * @return
	 */
	 ...
	 */
	@Override
	public abstract void execute(Context context) throws DebicoException;
