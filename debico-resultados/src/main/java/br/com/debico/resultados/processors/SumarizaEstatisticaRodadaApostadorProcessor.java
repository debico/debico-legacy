...
class SumarizaEstatisticaRodadaApostadorProcessor extends ProcessorSupport {
    ...
    private static final Logger LOGGER = LoggerFactory
	    .getLogger(SumarizaEstatisticaRodadaApostadorProcessor.class);
	...
	checkNotNull(context.getCampeonato(),
		"Campeonato deve ser especificado");
	...
	while (!pontuacao.isDone()) {
		...
		LOGGER.error(
			"[execute] Erro na thread de execucao da Sumarizacao.",
			e);
	    }
	}
	LOGGER.debug("[execute] Fim do processamento em: {}",
