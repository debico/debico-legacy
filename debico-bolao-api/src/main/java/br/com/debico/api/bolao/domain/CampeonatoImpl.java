...
public class CampeonatoImpl implements Campeonato, Serializable {
    ...
    @JoinTable(name = "tb_campeonato_time", joinColumns = {
            @JoinColumn(name = "ID_CAMPEONATO", referencedColumnName = "ID_CAMPEONATO", nullable = true, unique = false) }, inverseJoinColumns = {
                    @JoinColumn(name = "ID_TIME", referencedColumnName = "ID_TIME", nullable = true, unique = false) })
    ...
    protected CampeonatoImpl(final String nome, final String tipo) {
        this(nome);
        this.tipo = tipo;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hashCode(this.ativo, this.finalizado, this.id, this.nome, this.permalink);
    }

    @Override
    public String toString() {
        return toStringHelper(this).addValue(this.id).addValue(this.nome).addValue(this.permalink).omitNullValues()
                .toString();
    }
