...
public class Partida extends PartidaBase {
    ...
    @Override
    public int hashCode() {
        return super.hashCode() + Objects.hashCode(this.status, this.dataComputada);
    }

    @Override
    public String toString() {
        return super.toStringHelper().addValue(this.status).toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        return equal(this.getId(), that.getId()) && equal(this.getMandante(), that.getMandante())
                && equal(this.getVisitante(), that.getVisitante()) && equal(this.getPlacar(), that.getPlacar())
