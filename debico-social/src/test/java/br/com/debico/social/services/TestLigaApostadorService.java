...
public class TestLigaApostadorService extends AbstractUnitTest {
    ...
    public void testInscreverApostador() throws CadastroLigaException {
        // @formatter:off
		final Liga liga = ligaService.cadastrarNovaLiga("Liga da Justiça", TestConstants.MEU_ID_USUARIO);
    ...
    public void testRemoverApostador() throws CadastroLigaException {
        // @formatter:off
		Liga liga = ligaService.cadastrarNovaLiga("Liga da Justiça", TestConstants.MEU_ID_USUARIO);
