...
class UsuarioServiceImpl implements UsuarioService {
    ...
    public void cadastrarApostadorUsuario(Apostador apostador,
        ...
        /*
         * TODO: checar se não tiver email, pelo menos o profile da rede social.
         * e dessa forma verificar se já não está cadastrado. é imporvável que
         * isso aconteça, porque ele só deve chegar aqui sem email a partir do
         * ConnectionSignUp, que é o ato de relacionar o usuário com um profile.
         * 
         * Mesmo assim é interessante realizar essa checagem para manter o UC
         * coeso. Da mesma forma, rever esse fluxo, pois já está se tornando
         * muito complexo.
         */
        if (isNullOrEmpty(usuario.getEmail())
                || usuarioDAO.selecionarPorEmail(usuario.getEmail()) == null) {
    ...
    private Apostador construirApostadorComUserProfile(
        ...
        usuario.setSenha(RandomStringUtils.randomAlphanumeric(50));
