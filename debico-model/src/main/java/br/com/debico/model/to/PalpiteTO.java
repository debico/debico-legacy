...
public class PalpiteTO implements Serializable {
	...
	public PalpiteTO(final int idUsuario, final Placar placar, final int idPartida) {
	...
	@Override
	public int hashCode() {
		return Objects.hashCode(this.apostadorEmail, this.id, this.idPartida, this.placar);
	}

	@Override
	public String toString() {
		return toStringHelper(this).omitNullValues().addValue(this.placar).addValue(this.idPartida)
				.addValue(this.apostadorEmail).toString();
	}
	...
	public boolean equals(Object obj) {
		...
		return super.equals(obj) && equal(this.id, that.getId()) && equal(this.placar, that.getPlacar())
