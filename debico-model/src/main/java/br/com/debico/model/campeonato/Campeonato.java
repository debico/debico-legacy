...
public interface Campeonato {
    ...
    /**
     * Image da Home do Campeonato. Uma imagem bem grande e legal nos tamanhos: <code>970x500</code>
     * 
    ...
    /**
     * Recupera os dados de parametrização desse campeonato.
     * É uma estrutura de meta-dados para auxiliar funções e casos de uso de apoio. Não carrega do banco por padrão.
     * 
     * @return
     */
