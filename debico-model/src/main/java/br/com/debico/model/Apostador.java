...
public class Apostador implements Serializable, Comparable<Apostador> {
    ...
    public boolean possuiTimeCoracao() {
        return (this.getOpcoes().getTimeCoracao() != null && this.getOpcoes().getTimeCoracao().getId() > 0);
    }
    
    /**
     * Nome para aparecer em interfaces e saudações, também conhecido como <code>Display Name</code> ou <code>Screen Name</code>.
     * 
