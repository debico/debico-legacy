...
public class PartidaBase implements Serializable, Comparable<PartidaBase> {
	...
	public int compareTo(PartidaBase o) {
		return ComparisonChain.start().compare(this.dataHoraPartida, o.getDataHoraPartida())
				.compare(this.mandante, o.getMandante()).result();
	}

	@Override
	public int hashCode() {
		return Objects.hashCode(this.id, this.local, this.mandante, this.visitante, this.dataHoraPartida,
				this.computadaCampeonato);
	}

	protected ToStringHelper toStringHelper() {
		return Objects.toStringHelper(this).add("em ", this.local)
				.addValue(String.format("%s X %s", this.mandante, this.visitante)).addValue(this.placar)
				.omitNullValues();
	}
	...
	public boolean equals(Object obj) {
		...
		return equal(this.id, that.getId()) && equal(this.mandante, that.getMandante())
