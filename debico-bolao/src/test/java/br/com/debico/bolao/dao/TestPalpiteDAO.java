...
public class TestPalpiteDAO extends AbstractUnitTest {
	...
	public void testInserir() {
		Apostador apostador = new Apostador("Peter Parker", new Usuario("peter@oscorp.com"));
		...
		PartidaChave partida = new PartidaChave(mandante, visitante, new Placar(2, 0));
