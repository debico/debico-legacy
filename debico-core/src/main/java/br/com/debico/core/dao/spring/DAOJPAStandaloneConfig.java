...
@PropertySource(value = "classpath:/br/com/debico/core/debico-standalone.properties", ignoreResourceNotFound = false)
public class DAOJPAStandaloneConfig extends DAOJPAConfig {

    /**
     * If you want to use something mature and performant (e.g. not Apache
     * DBCP), use BoneCP.
     * 
    ...
    public DataSource dataSource() throws Exception {
        ...
        dataSource.setDriverClass(environment
                .getProperty("br.com.debico.db.driver"));
        dataSource.setJdbcUrl(environment.getProperty("br.com.debico.db.url"));
        dataSource
                .setUsername(environment.getProperty("br.com.debico.db.user"));
        dataSource.setPassword(environment
                .getProperty("br.com.debico.db.password"));
        dataSource.setMaxConnectionsPerPartition(Integer.parseInt(environment
                .getProperty("br.com.debico.db.initialsize")));
        dataSource.setConnectionTestStatement(environment
                .getProperty("br.com.debico.db.validation_query"));
