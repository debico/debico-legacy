 ...
 * @see <a href="https://code.google.com/p/selenium/wiki/PageObjects">Page
 *      Objects</a>
 * @see <a
 *      href="https://code.google.com/p/selenium/wiki/PageFactory">PageFactory</a>
 */
public class LoginPage extends AbstractPage {
    ...
    public LoginPage typeUsername(String username) {
        this.clearAndType(usernameLocator, username);
        return this;
    }

    public LoginPage typePassword(String password) {
        this.clearAndType(passwordLocator, password);
        return this;
    }
