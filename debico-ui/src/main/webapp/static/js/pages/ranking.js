// TODO: exportar para a API Debico
function DesempenhoApostador(aposCarregarGrafico) {
	...
	self.carregarGrafico = function() {
		$
				.getJSON(
						URLS.widgets.desempenho,
						function(responseBody) {
							if (!responseBody || !responseBody.data
									|| responseBody.data.length <= 0) {
								self.onAposCarregarGrafico.call(self, null,
										false);
								return;
							}
				...
				.fail(
						function() {
							$
									.notify(
											"Houvem um problema ao carregar os seus dados de desempenho.",
											"error");
