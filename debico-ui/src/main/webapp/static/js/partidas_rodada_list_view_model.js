...
function PartidasRodadaListViewModel(baseUrl) {
	...
	// so assim pra funcionar o bind. ele nao acessa propriedade de outro objeto
	// dentro do template.
...
/**
 * Deve ser implementada de forma que carregue as partidas de acordo com o
 * contexto.
 * 
 * @param urlPartidas
 */
 ...
 */
PartidasRodadaListViewModel.prototype.carregarPartidasRodadaDirecao = function(
		direcao) {
	var self = this;
