/**
 * Depreciar esse script e passar as interações com a view para
 * controller.widget.rodada.js e as chamadas para as APIs correspondentes.
 */
...
$(document).ready(
		function() {
			...
			ko.applyBindings(rodadasNavViewModel, document
					.getElementById("rodadas-nav"));
		});