...
// Estencao
PartidasRodadaEditViewModel.prototype = Object.create(PartidasRodadaListViewModel.prototype);
PartidasRodadaEditViewModel.prototype.constructor = PartidasRodadaEditViewModel;

/**
 * Carrega as partidas do servidor a partir de uma URL.
 * <p/>
 * Para entender o "subscribe" das entidades abaixo, ver o capítulo
 * <b>Explicitly subscribing to observables</b> no link abaixo.
 * 
