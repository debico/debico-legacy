...
public class PartidasWidgetController {
    ...
    public @ResponseBody List<PartidaRodada> selecionarPartidas(@PathVariable(value="id") int id) {
    ...
    public @ResponseBody List<PartidaRodada> selecionarPartidas(@PathVariable(value="permalink") String permalink, @PathVariable(value="ordinal") int ordem) {
